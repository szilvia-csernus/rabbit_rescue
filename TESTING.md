...
In Code Institute's dedicated Peer Code Review channel, one feedback I received was that my rabbit pictures in the gallery section are not clearly distinguishable from each other, as there was no border or gaps between the pictures. I rectified this by adding `0.3rem` wide gaps around the pictures.
